...
###################################
###### Navigation
$LNG['honor_good_1'] = '<font color="#3366cc">Seigneur des étoiles</font>';
$LNG['honor_good_2'] = '<font color="#0099cc">Empereur</font>';
$LNG['honor_good_3'] = '<font color="#33cccc">Empereur Suprême</font>';
$LNG['honor_bad_1'] = '<font color="orange">Bandit</font>';
$LNG['honor_bad_2'] = '<font color="orange">Seigneur Bandit</font>';
$LNG['honor_bad_3'] = '<font color="red">Roi Bandit</font>';
###### Words 
$LNG['create'] = 'Créer';
$LNG['deposit'] = 'Déposer';
$LNG['day'] = 'Jour';
$LNG['btn_vote'] = 'Votez pour %s';
$LNG['btn_prosperity'] = 'Prospérité';
$LNG['btn_synthetic'] = 'Automates';
###### Navigation
$LNG['nav_planet_arrowleft'] = 'Il n\'y a pas de planète avant';
$LNG['nav_planet_arrowright'] = 'Il n\'y a pas de planète après';
$LNG['nav_resource_current'] = 'Actuel';
$LNG['nav_resource911_free'] = 'Libre';
$LNG['nav_resource_production'] = 'Total';
$LNG['nav_resource_biome'] = 'Bonus Planète';
$LNG['nav_resource_star'] = 'Bonus étoile';
$LNG['nav_terraform'] = 'Cette planète est en cours de terraformation';
$LNG['nav_fleet_alarm'] = 'Activitée ennemie';
$LNG['nav_fleet_noactivity'] = 'Pas de flotte active';
$LNG['nav_resolution_fix'] = 'Cette résolution n\'est pas recommandée lorsque vous jouez sur un navigateur Smartphone/Tablette. Certaines parties pourraient être masquées';
###### Error Handler
$LNG['err_resource_3'] = 'Vous n\'avez pas assez de ressources. Il vous faut : %s Métal, %s Crystal, %s Deuterium.';
$LNG['err_resource_921'] = 'Vous n\'avez pas assez de ressources<p> Il vous faut : %s Matière Noire.';
$LNG['err_no_resource_921'] = 'Pas assez de Matière Noire';
$LNG['err_chat_1'] = 'Vous allez trop vite. Jouez un peu plus au jeu pour pouvoir rejoindre le chat.';

###################################
###################################
###### Page: Ancient
###### Errors
$LNG['err_mothership_1'] = 'Remise aux valeurs par défaut.';
$LNG['err_mothership_2'] = 'Vous n\'avez pas assez de ressources. Il vous faut : %s Métal, %s Crystal, %s Deuterium.';
$LNG['err_mothership_3'] = 'Vous avez remis les valeurs par défaut. Aucun module installé.';
$LNG['err_mothership_4'] = 'Impossible d\'installer de module pendant la construction.';
$LNG['err_mothership_5'] = 'Pas assez d\'énergie pour installer ce module. Améliorez votre réacteur ou utilisez un module moins coûteux.';
$LNG['err_mothership_6'] = 'Vous n\'avez pas assez de ressources pour installer ce module.';
$LNG['err_mothership_7'] = 'Ce module a été installé.';
$LNG['err_mothership_8'] = 'Ce module a été retiré.';
$LNG['err_mothership_9'] = 'Ce module ancestral a été créé. Veuillez rafraichir la page.';
$LNG['err_mothership_10'] = 'Vous en possédez déjà un.';
$LNG['err_mothership_11'] = 'Vous n\'avez pas la technologie requise';
$LNG['err_mothership_12'] = 'Vous ne pouvez vendre ce module que si vous le possédez';
$LNG['err_mothership_13'] = 'Ce module a été vendu pour %s unitées de Matière Noire.';
$LNG['err_mothership_14'] = 'Votre vaisseau mère ou canon ancestral sont attaqués. Vous ne pouvez ainsi pas changer de module.';
$LNG['err_mothership_15'] = 'Aucun type de vaisseau custom sélectionné.';
###### Text
$LNG['module'] = "Module";
$LNG['nomodule'] = "Module manquant";
$LNG['page_mothership_prototype'] = "Prototype";
$LNG['page_mothership_soon'] = "Bientôt";
$LNG['page_mothership_owned'] = "Possédé";
$LNG['page_mothership_remove'] = "Retirer";
$LNG['page_mothership_equipped'] = "Equipé";
$LNG['page_mothership_install'] = "Installer";
$LNG['page_mothership_scrap'] = "Recycler";
$LNG['page_mothership_scrap_title'] = "Récupérer des ressources";
$LNG['page_mothership_find_module_tech'] = "Trouver ce module lors d'une expédition requière Tech Ancestrale %s ou plus";
$LNG['page_mothership_find_module_event'] = "Ce module ne peut être acquis que lors d'évenements";
$LNG['page_mothership_miss_tech'] = "Technologie manquante";
$LNG['page_mothership_module_costAfter'] = "Ajoute au prix du vaisseau";
$LNG['page_mothership_module_costInstall'] = "Coût d'installation";
$LNG['page_mothership_module_weapons'] = "Armes";
$LNG['page_mothership_module_weapons_desc'] = "Ce module constitue le type d'arme de votre vaisseau.";
$LNG['page_mothership_module_reactor'] = "Reacteur";
$LNG['page_mothership_module_reactor_desc'] = "Chaque module du vaisseau mère a besoin d'énergie et le réacteur doit donc en fournir suffisament.";
$LNG['page_mothership_module_engine'] = "Moteur";
$LNG['page_mothership_module_engine_desc'] = "Ce module modifie le type de moteur du vaisseau, sa vitesse et consommation en deutérium";
$LNG['page_mothership_module_armor'] = "Blindage";
$LNG['page_mothership_module_armor_desc'] = "Ce module détermine la quantité de cargaison du vaisseau mère.";
$LNG['page_mothership_module_shield'] = "Bouclier";
$LNG['page_mothership_module_shield_desc'] = "Ce module est requis pour protéger le blindage.";
$LNG['page_mothership_module_auxiliary'] = "Auxiliaire";
$LNG['page_mothership_module_auxiliary_desc'] = "Ce module permet de débloquer des bonus pour le vaisseau, comme de nouvelles missions.";
$LNG['page_mothership_module_ancienttech'] = "Cette page affiche les modules pouvant être obtenus durant les éxpéditions. Pour les divérisfier, améliorez la technologie Ancestrale";
$LNG['page_mothership_module_expedition'] = "To acquire this module, you must first find it in Expedition mission";
$LNG['page_mothership_module_notech'] = "Niveau technologique insuffisant pour débloquer ce module";
$LNG['page_mothership_module_equipped'] = "Ce module est déjà équipé sur votre vaisseau mère";
###### Modules
$LNG['engine'] = "Moteur";
$LNG['shield'] = "Bouclier";
$LNG['armor'] = "Blindage";
$LNG['reactor'] = "Réacteur";
$LNG['weapon'] = "Arme";
$LNG['template'] = "Classe";
$LNG['auxiliary'] = "Auxiliaire";
$LNG['h_default'] = "Defaut";
$LNG['h_fallen_empire'] = "Colosse";
$LNG['h_ancient_mothership'] = "Vaisseau Mère Ancestral";
$LNG['ship_part_thruster_1'] = "Propulseurs Chimiques";
$LNG['ship_part_thruster_2'] = "Propulseurs Ioniques";
$LNG['ship_part_thruster_3'] = "Propulseurs à Plasma";
$LNG['ship_part_thruster_4'] = "Propulseurs à Impulsion";
$LNG['ship_part_warp_drive_1'] = "Moteur à Distorsion ";
$LNG['ship_part_warp_drive_2'] = "Stabilisateur de champs de Distorsion";
$LNG['ship_part_warp_drive_3'] = "Statoréacteur à Distorsion";
$LNG['ship_part_hyperdrive'] = "Moteur Hyperespace";
$LNG['ship_part_wormhole'] = "Moteur à trou de ver";
$LNG['ship_part_sensor_1'] = "Système de radar";
$LNG['ship_part_sensor_2'] = "Capteurs Gravitationnels";
$LNG['ship_part_sensor_3'] = "Capteurs sous-spaciaux";
$LNG['ship_part_sensor_4'] = "Capteurs Tachyons";
$LNG['ship_part_laser_1'] = "Laser Rouge";
$LNG['ship_part_laser_2'] = "Laser Bleu";
$LNG['ship_part_laser_3'] = "Laser UV";
$LNG['ship_part_laser_4'] = "Laser X-Ray ";
$LNG['ship_part_laser_5'] = "Laser Gamma";
$LNG['ship_part_energy_lance_1'] = "Lance à Particules";
$LNG['ship_part_energy_lance_2'] = "Lance Tachyon";
$LNG['ship_part_plasma_1'] = "Lanceur Plasma";
$LNG['ship_part_plasma_2'] = "Accélérateur Plasma";
$LNG['ship_part_plasma_3'] = "Canon Plasma";
$LNG['ship_part_arc_emitter_1'] = "Eméteur à Arc";
$LNG['ship_part_arc_emitter_2'] = "Eméteur à Arc Concentré";
$LNG['ship_part_disruptor_1'] = "Disrupteur";
$LNG['ship_part_disruptor_2'] = "Disrupteur Ionique";
$LNG['ship_part_disruptor_3'] = "Disrupteur de Phase";
$LNG['ship_part_energy_torpedo_1'] = "Torpilles à Protons";
$LNG['ship_part_energy_torpedo_2'] = "Torpilles à Neutrons";
$LNG['ship_part_extradimensional_weapon_1'] = "Désintégrateur de Matière";
$LNG['ship_part_mining_drone_laser_1'] = "Laser de Drone d'Extraction";
$LNG['ship_part_space_cloud_weapon_1'] = "Nuage de Foudre";
$LNG['ship_part_space_whale_weapon_1'] = "Siphon à Energie";
$LNG['ship_part_missile_1'] = "Missiles Nucléaires";
$LNG['ship_part_missile_2'] = "Missiles à Fusion";
$LNG['ship_part_missile_3'] = "Antimatter Missiles";
$LNG['ship_part_missile_4'] = "Missiles Antimatière";
$LNG['ship_part_missile_5'] = "Missiles Maraudeurs";
$LNG['ship_part_swarmer_missile_1'] = "Essain de Missiles";
$LNG['ship_part_swarmer_missile_2'] = "Tourbillon de Missiles";
$LNG['ship_part_torpedo_1'] = "Torpilles Spatiales";
$LNG['ship_part_torpedo_2'] = "Torpilles Blindées";
$LNG['ship_part_torpedo_3'] = "Torpilles Dévastatrices";
$LNG['ship_part_scourge_missile_1'] = "Missile du Fléau";
$LNG['ship_part_mass_driver_1'] = "Catapulte Energétique";
$LNG['ship_part_mass_driver_2'] = "Canon Magnétique";
$LNG['ship_part_mass_driver_3'] = "Canon Electrique";
$LNG['ship_part_mass_driver_4'] = "Canon Electrique Avancé";
$LNG['ship_part_mass_driver_5'] = "Cannon de Gauss";
$LNG['ship_part_kinetic_artillery_1'] = "Batterie Cinétique";
$LNG['ship_part_kinetic_artillery_2'] = "Artillerie Cinétique";
$LNG['ship_part_mass_accelerator_1'] = "Canon Mega";
$LNG['ship_part_mass_accelerator_2'] = "Canon Giga";
$LNG['ship_part_autocannon_1'] = "Canon Automatique";
$LNG['ship_part_autocannon_2'] = "Canon Faucheur Automatique";
$LNG['ship_part_autocannon_3'] = "Canon Tempête de Feu Automatique";
$LNG['ship_part_strike_craft_scout_1'] = "Eclaireurs";
$LNG['ship_part_strike_craft_fighter_1'] = "Chasseurs";
$LNG['ship_part_strike_craft_fighter_2'] = "Chasseurs Améliorés";
$LNG['ship_part_strike_craft_fighter_3'] = "Chasseurs Avancés";
$LNG['ship_part_strike_craft_bomber_1'] = "Bombardiers";
$LNG['ship_part_strike_craft_bomber_2'] = "Bombardiers Améliorés";
$LNG['ship_part_strike_craft_bomber_3'] = "Bombardiers Avancés";
$LNG['ship_part_amoeba_strike_craft_1'] = "Amoeba Flagella"; // Sugestions needed
$LNG['ship_part_swarm_strike_craft_1'] = "Essain d'Assaut";
$LNG['ship_part_point_defense_1'] = "Sentinelle de Défense Ciblée";
$LNG['ship_part_point_defense_2'] = "Barrière de Défense Ciblée";
$LNG['ship_part_point_defense_3'] = "Gardien de Défense Ciblée";
$LNG['ship_part_reactor_1'] = "Réacteur à Fusion";
$LNG['ship_part_reactor_2'] = "Réacteur à Fusion";
$LNG['ship_part_reactor_3'] = "Réacteur à Fusion Froide";
$LNG['ship_part_reactor_4'] = "Réacteur à Antimatière";
$LNG['ship_part_reactor_5'] = "Réacteur à Vide Quantique";
$LNG['ship_part_hyper_drive_1'] = "Réacteur Hyperlane"; // Sugestions needed
$LNG['ship_part_hyper_drive_2'] = "Réacteur à brèche Hyperlane"; // Sugestions needed
$LNG['ship_part_hyper_drive_3'] = "Réacteur Hyperespace"; 
$LNG['ship_part_enigmatic_power_core'] = "Noyau de puissance énigmatique";
$LNG['ship_part_armor_1_defense'] = "Blindage Nano-composite";
$LNG['ship_part_armor_2_defense'] = "Blindage Ceramo-Métalique";
$LNG['ship_part_armor_3_defense'] = "Blindage Plasteel";
$LNG['ship_part_armor_4_defense'] = "Blindage Durasteel";
$LNG['ship_part_armor_5_defense'] = "Blindage Neutronium";
$LNG['ship_part_dragon_armor_defense'] = "Blindage en Ecailles de Dragon";
$LNG['ship_part_armor_1_shipyard'] = "Blindage Nanocomposite";
$LNG['ship_part_armor_2_shipyard'] = "Blindage Ceramo-Métalique";
$LNG['ship_part_armor_3_shipyard'] = "Blindage Plasteel";
$LNG['ship_part_armor_4_shipyard'] = "Blindage Durasteel";
$LNG['ship_part_armor_5_shipyard'] = "Blindage Neutronium";
$LNG['ship_part_dragon_armor_shipyard'] = "Blindage en Ecailles de Dragon";
$LNG['ship_part_shield_1'] = "Déflecteurs";
$LNG['ship_part_shield_2'] = "Déflecteurs Améliorés";
$LNG['ship_part_shield_3'] = "Boucliers";
$LNG['ship_part_shield_4'] = "Boucliers Avancés";
$LNG['ship_part_shield_5'] = "Hyper Boucliers";
$LNG['ship_part_enigmatic_shield'] = "Déflecteurs Enigmatiques";
$LNG['ship_part_psi_shield'] = "Boucliers Psioniques";
$LNG['ship_part_crystal_armor_1'] = "Plaque Infusée en Crystal";
$LNG['ship_part_crystal_armor_2'] = "Plaque Forgée en Crystal";
$LNG['ship_part_auto_repair'] = "Coque en Tissus Régénérants";
$LNG['ship_part_shield_recharger'] = "Chargeurs de Boucliers";
$LNG['ship_part_afterburners_1'] = "Postcombustion";
$LNG['ship_part_afterburners_2'] = "Postcombustion Avancée";
$LNG['ship_part_enigmatic_encoder'] = "Encodeur Enigmatique";
$LNG['ship_part_enigmatic_decoder'] = "Décodeur Enigmatique";
$LNG['ship_part_aura_shield_dampener'] = "Condensateurs de Boucliers";
$LNG['ship_part_aura_shield_recharger'] = "Champs de Condensateurs";
$LNG['ship_part_enigmatic_disruption_field'] = "Champs de Disruption Enigmatique";
$LNG['ship_part_archeology_lab'] = "Labo d'Archeologie";
$LNG['ship_part_curator_lab'] = "Labo Extradimmensionnel";
$LNG['ship_part_science_lab_1'] = "Labo D'Exploration ";
$LNG['ship_part_computer_aggressive_basic'] = "Ordinateur d'Attitude Aggrésive";
$LNG['ship_part_computer_aggressive_advanced'] = "Ordinateur d'Attitude Aggrésive Avancé";
$LNG['ship_part_computer_defensive_basic'] = "Ordinateur d'Attitude Défensive";
$LNG['ship_part_computer_defensive_advanced'] = "Ordinateur d'Attitude Défensive Avancé";
$LNG['ship_part_computer_pregoc'] = "Ordinateur d'Attitude Furtive";
$LNG['ship_part_psi_jump_drive_1'] = "Invertion Psionic";
$LNG['ship_part_border_extruder_1'] = "Lois Enérgétiques I";
$LNG['ship_part_border_extruder_2'] = "Lois Enérgétiques II";
$LNG['ship_part_border_extruder_3'] = "Lois Enérgétiques III";
$LNG['ship_part_jump_drive_1'] = "Moteur de Saut";
$LNG['ship_part_jump_drive_1_info'] = "Double la vitesse";
$LNG['ship_basic_weapon'] = "Armes Recherchées";
$LNG['ship_basic_engine'] = "Researched Engine Recherchées";
$LNG['ship_basic_reactor'] = "Researched Reactor Recherchées";
$LNG['ship_basic_armor'] = "Researched Armor Recherchées";
$LNG['ship_basic_shield'] = "Researched Shield Recherchées";
# Custom modules
$LNG['ship_part_crystal_armor_1_custom'] = "-10% Coût de Construction";
$LNG['ship_part_crystal_armor_2_custom'] = "-20% Coût de Construction";
$LNG['ship_part_auto_repair_custom'] = "+20% Bouclier";
$LNG['ship_part_shield_recharger_custom'] = "+20% Bouclier";
$LNG['ship_part_afterburners_1_custom'] = "-20% Consommation +10% Vitesse";
$LNG['ship_part_afterburners_2_custom'] = "-40% Consommation +20% Vitesse";
$LNG['ship_part_aura_shield_dampener_custom'] = "+50% Bouclier";
$LNG['ship_part_aura_shield_recharger_custom'] = "+100% Bouclier";
$LNG['ship_part_enigmatic_disruption_field_custom'] = "+200% Bouclier";
...
$LNG['ship_part_computer_defensive_basic_custom'] = "+10% Attaque +10% Défense";
$LNG['ship_part_computer_defensive_advanced_custom'] = "+20% Attaque +20% Défense";
$LNG['ship_part_border_extruder_1_custom'] = "+10% Energie";
$LNG['ship_part_border_extruder_2_custom'] = "+20% Energie";
$LNG['ship_part_border_extruder_3_custom'] = "+30% Energ";
$LNG['ship_part_jump_drive_1_custom'] = "+100% Vitesse";
$LNG['h_fallen_empire_custom'] = "-10% Coût de Construction";
# Space Dragon
$LNG['ship_part_dragon_breath'] = "Jet d'Ether";
$LNG['ship_part_dragon_shield'] = "Bouclier d'Ether";
$LNG['h_space_dragon'] = "Blindage d'Ether";
$LNG['h_space_dragon_custom'] = "+10% Attaque";
# Enigmatic Fortress
$LNG['ship_part_enigmatic_attack'] = "Noyau de Combat Enigmatique";
$LNG['ship_part_enigmatic_attack_custom'] = "+25% Attaque";
$LNG['ship_part_enigmatic_consumption'] = "Noyau de Deuterium Enigmatique";
$LNG['ship_part_enigmatic_consumption_custom'] = "-25% Consommation";
$LNG['ship_part_enigmatic_energy'] = "Noyau de Réacteur Enigmatique";
$LNG['ship_part_enigmatic_energy_custom'] = "+25% Energie";
$LNG['ship_part_enigmatic_shield'] = "Noyau de Bouclier Enigmatique";
$LNG['ship_part_enigmatic_shield_custom'] = "+25% Bouclier";
$LNG['ship_part_enigmatic_special'] = "Stabilisateur Enigmatique";
$LNG['ship_part_enigmatic_special_custom'] = "+10% Bonus sur les modules de classe Enigmatique";
$LNG['h_enigmatic_fortress'] = "Forteresse Enigmatique";
$LNG['h_enigmatic_fortress_custom'] = "+100% Bouclier";
# Crafted Modules
$LNG['C_ship_part_arc_emitter_3'] = "Emetteur d'Arc Convexe";
$LNG['C_ship_part_arc_emitter_4'] = "Emetteur d'Arc Convertis";

###################################
###################################
###### Page: Black Market
###### Button
$LNG['button_overview_PlanetMoon'] = "Créer Lune";  
$LNG['button_overview_PlanetFields'] = "Cases";
###### Error
$LNG['err_bm_notexist'] = "Cette Feature n'existe pas";
###### Text
$LNG['lm_bm_PlanetMoon'] = "Créateur De Lune";
$LNG['lm_bm_PlanetMoon_desc'] = "Des mercenaires suicidaires de l'ordre Rebelle s'auto détruiront sur l'orbite de votre Planète pour y créer une lune.";
$LNG['lm_bm_blackList_err_1'] = "Seulement sur les planètes sans lune.";
$LNG['lm_bm_PlanetFields'] = "Habitats Sous-terrains";
$LNG['lm_bm_PlanetFields_desc'] = "Des esclaves la prison inter-galactique travailleront sur votre planète pour l'aggrandir de 50 cases.";
$LNG['lm_bm_blackList_err_2'] = "A utiliser sur des Planètes";
$LNG['lm_bm_blackList_3'] = "Trou de ver pour Mega-structure";
$LNG['lm_bm_blackList_desc_3'] = "Réduit de 35% le temps de mission restant de votre Mega-structure.";
$LNG['lm_bm_blackList_err_3'] = "";
$LNG['lm_bm_blackList_4'] = "Amplificateur de Recherche";
$LNG['lm_bm_blackList_desc_4'] = "Réduit 35% le temps de Recherche restant.";
$LNG['lm_bm_blackList_err_4'] = "La Recherche doit durer plus d'une minute";
$LNG['lm_bm_blackList_5'] = "Amplificateur de Construction";
$LNG['lm_bm_blackList_desc_5'] = "Réduit de 50% le temps de construction restant.";
$LNG['lm_bm_blackList_err_5'] = "La construction doit durer plus d'une minute";
$LNG['lm_bm_blackList_6'] = "Amplificateur de Terraformation ";
$LNG['lm_bm_blackList_desc_6'] = "Réduit de 35% le temps de Terraformation restant.";
$LNG['lm_bm_blackList_err_6'] = "La terraformation doit durer plus d'une minute";
...
$LNG['tab_building_1_2'] = 'Industries';
$LNG['tab_building_1_3'] = 'Labos';
$LNG['tab_building_1_4'] = 'Ressources';
$LNG['tab_building_1_5'] = 'Terraformation';
$LNG['tab_building_1_6'] = 'Automates';
###### Buttons for Moons
$LNG['tab_building_3_1'] = 'Base Lunaire';
$LNG['tab_building_3_2'] = 'Industries';
$LNG['tab_building_3_3'] = 'Labos';
$LNG['tab_building_3_4'] = 'Portail';
###### Buttons for Ring
$LNG['tab_building_4_1'] = 'Mines';
$LNG['tab_building_4_2'] = 'Industries';
$LNG['tab_building_4_3'] = 'Labos';
$LNG['tab_building_4_4'] = 'Ressources';
$LNG['tab_building_4_5'] = 'Automates';
$LNG['tab_building_4_6'] = 'Portail';
###### Buttons for Habitat
$LNG['tab_building_5_1'] = 'Mines';
$LNG['tab_building_5_2'] = 'Industries';
$LNG['tab_building_5_3'] = 'Labos';
$LNG['tab_building_5_4'] = 'Coordonnées';
$LNG['tab_building_5_5'] = 'Ressources';
$LNG['tab_building_5_6'] = 'Automates';
# Text
$LNG['page_buildings_fields'] = 'Chaque niveau de batîment coûte une case. Chaque planète a un nombre de case limité. Pour l\'augmenter vous pouvez en acheter au Marché Noir ou améliorer le niveau de Terraformation';
$LNG['page_buildings_prosperity'] = '<ul><li>La prospérité est le niveau de bonheur de la planète.</li><li> Les planètes conquises peut être récupérées si le niveau de propsérité est inférieur à 10%.</li><li>Le niveau de propsérité est réduit par les attaques gagnées.</li><li>Vous pouvez regagner de la prospérité en améliorant le Complexe Impérial</li></ul>';
$LNG['page_buildings_quick_desc'] = 'Réduit de 50% le temps restant pour';
$LNG['page_buildings_biome_prod'] = 'Ce biome modifie la production de votre planète:';

###################################
###################################
###### Page: Dark Matter
###### Buttons
$LNG['btn_darkmatter_voucher'] = 'Bons';
###### Error
$LNG['err_darkmatter_paypal'] = "Nous sommes désolés, quelque chose s'est mal passé durant l'enregistrement de la transaction. Veuillez réessayer.";
$LNG['err_darkmatter_voucher_valid'] = "Nous sommes désolés, mais le bon <b>%s</b> n'est pas valied";
$LNG['err_darkmatter_voucher_expired'] = "Nous sommes désolés, mais le bon <b>%s</b> a expérité il y a %s";
$LNG['err_darkmatter_voucher_use_expired'] = "Nous sommes désolés, mais le bon <b>%s</b> a déjà été utilisé par un autre joueur.";
$LNG['err_darkmatter_voucher_used'] = "Nous sommes désolés,mais vous avez déjà utilisé le bon <b>%s</b>";
$LNG['err_darkmatter_voucher_active'] = "Bon <b>%s</b> activé avec succès. Vous avez reçu %s Matière Noire";
###### Text
$LNG['page_darkmatter_voucher_desc'] = 'Insérez le code que vous avez reçu';
$LNG['page_darkmatter_rule_1'] = 'Vous pouvez obtenir de la Matière Noire en Expedition, en vendant des modules de Canon ou Vaisseau Mère Ancients ou en votant pour Stellaron.';
$LNG['page_darkmatter_rule_2'] = 'Stellaron est un jeu gratuit, où payer n\'est pas nécessaire pour qu\'un joueur s\'amuse.';
$LNG['page_darkmatter_rule_3'] = 'La Matière Noire sert à obtenir certains bonus et débloquer des fonctionnalités supplémentaires, et ne devrait pas être vue comme une partie intégrale du coeur du jeu.';
$LNG['page_darkmatter_rule_4'] = 'Une fois acheté, votre paiement ne peut être remboursé, et l\'utilisateur ne possède aucunement le droit de demander ou prétendre au remboursement du montant dépensé.'; // Don't know if should translate legal mentions. 
$LNG['page_darkmatter_rule_5'] = 'Après achat, la Matière Noire est disponible instantanément dans l\'univers où vous l\'avez achetée';
$LNG['page_darkmatter_rule_6'] = 'Etre banni d\'un univers pour violation des règles ou des termes et conditions d\'utilisation, ne donne à l\'utilisateur aucun droit de demander ou prétendre au remboursement de la Matière Noire dans n\'importe quel univers de Stellaron.';
$LNG['page_darkmatter_rule_7'] = 'L\'occurrence de bugs (Même pour les fonctionnalités rendues disponibles grâce à la Matière Noire) ne donne à l\'utilisateur aucun droit de demander ou prétendre au remboursement du montent dépensé.';
$LNG['page_darkmatter_rule_8'] = 'L\'Administration se réserve le droit d\'appliquer n\'importe quelle mesure de compensation qu\'elle juge appropriée, en énonçant sa justification.';
...
###### Text
$LNG['page_fleetTable_template_desc'] = 'Now you can quickly define which ships you want to send to certain mission and name sit They will be available on fleet selection page so you can click and quickly send your desired fleet. You get free two planners and you can purchase more for %s units of Matière Noire';
###### Custom
# Additional Missions
...
$LNG['help_fleetTable2_11']	= "Send Matière Noire Collector ship from your moon to expedition position.";
...
$LNG['help_fleetTable2_56']	= "Create a capsule around the sun to produce Matière Noire. Requires Megaengineer and Megastructure Engineering (7)";
...
###### Errors
$LNG['err_galaxy_move_cost'] = 'You do not have enough Matière Noire to move the colony. You need more %s .';
...
###### Page: Dyson
$LNG['page_dyson_prod']  		= "This megastructure produces %s Matière Noire per hour";
...
###### Page: Decompressor
$LNG['page_decompressor_desc']  		= "The Matter Decompressor allows the conversion of Matière Noire into resources. This megastructure is immune to any attack and ships can not be sent to it due to its strong gravitional field and strategic position, a star.";
$LNG['page_decompressor_rule_1']  		= "Matière Noire is drained until it's produced the expected amount of resources per hour";
$LNG['page_decompressor_rule_2']  		= "You can not refund the resource gathered to get back Matière Noire invested. If you want to stop Matière Noire consumption, you need to set Power Usage to 0%";
$LNG['page_decompressor_rule_3']  		= "Matière Noire consumption is increased by the number of planets you can support on your empire.";
...
$LNG['type_planet_dyson_desc']		= "These multi-staged, truncated icosahedron-shaped structures harness the energy output of an entire star. A fully constructed Dyson Sphere provides a massive energy that allows you to produce Matière Noire.";
...
$LNG['mission_unlock_1_desc'] = "Being Resourceful worths more than simple amounts of Matière Noire";
...
$LNG['mission_stars'] = "Have colonized your planets in all possible star types";
###### Daily Mission
$LNG['mission_daily_1'] = "%s Matière Noire";
$LNG['mission_daily_1_desc'] = "Acquire bonus Matière Noire to sustain your empire needs.";
...
$LNG['mission_daily_4'] = "%s Matière Noire, %s Metal, %s Crystal & %s Deuterium";
$LNG['mission_daily_4_desc'] = "Get both Matière Noire and resources to grow your empire.";
...
$LNG['err_terraform_short_verify'] = 'You can shorten the terraform time by half paying %s Matière Noire.';
...
$LNG['page_terraform_bonus']				= "Terraform can not be finished with Matière Noire. You can terraform a planet more than once. Each Terraform level reduces the time by 1% and increases the future terraformation resource interval by 0.2%.";
...
# Text
$LNG['page_vote_1_desc'] = 'Your legit votes will be counted for the most voted users. You will get your Matière Noire instantly after you hit the Vote button on the votesite. Take a look in the Challenge tab!';
$LNG['page_vote_2_desc'] = 'Increase the prizepool by voting for Stellaron. At the end of the week, the prizepool is distributed with the top 10 voters of the game. Can you show to the universe your loyalty?</h6><h6>If you are not eligible for the prizepool, 50% of Matière Noire you have received by voting will be given again when time expires.';
...
$LNG['shortDescription'][156] = "This research allows you to build Dyson Sphere and optimizes the conversion of entire sun light and radiation into a production of Matière Noire";
$LNG['longDescription'][156] = "This research allows you to build Dyson Sphere and optimizes the conversion of entire sun light and radiation into a production of Matière Noire";
...
$LNG['shortDescription'][158] = "This research allows you to build Matter Decompressor and improves both resource production and Matière Noire consumption from Matter Decompressor.";
$LNG['longDescription'][158] = "This research allows you to build Matter Decompressor and improves both resource production and Matière Noire consumption from Matter Decompressor.";
