...
$LNG['err_darkmatter_voucher_active'] = "Voucher <b>%s</b> activated successfully. You have received %s Matière Noire";
###### Text
$LNG['page_darkmatter_voucher_desc'] = 'Insert the code you have received.';
$LNG['page_darkmatter_rule_1'] = 'You can get Matière Noire through Expedition, selling Ancient defenses and Mothership Modules or voting for Stellaron.';
$LNG['page_darkmatter_rule_2'] = 'Stellaron is a free game, not having any payment for a player to enjoy it.';
$LNG['page_darkmatter_rule_3'] = 'Matière Noire serve to obtain certain bonuses and to unlock extra functionalities, and should not be seen as an integral part of the core of the game.';
...
$LNG['page_darkmatter_rule_5'] = 'After purchase, Matière Noire are available instantly on the universe you have purchased.';
$LNG['page_darkmatter_rule_6'] = 'Being banned from certain universe for violation of rules or terms and conditions of use, does not give the user any right to claim or refund the existing Matière Noire in any universe of Stellaron.';
$LNG['page_darkmatter_rule_7'] = 'The occurrence of bugs (even in the features made available through Matière Noire) does not give the user any right to claim or refund the amount spent.';
